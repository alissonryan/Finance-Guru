...
If the user does not specify a template, list options under `@src/apps/projects/finance-guru/.guru-core/templates/` (e.g., `analysis-report.md`, `presentation-format.md`, `excel-model-spec.md`). Ask which deliverable they need and confirm output filename + format.
